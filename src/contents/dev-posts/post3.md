...
<figure class="relative">
  <p>
    <video controls class="overflowing">
      <source src="./images/post3/live-reload.h264.mp4" type="video/mp4">
    </video>
  </p>
  <figcaption class="gatsby-resp-image-figcaption">A short video of the live reload feature in
...
### Saving files in Vim, and the curious case of 4913
...
the first one _while_ the build is still running.
...
A **_watch_** goroutine watches for file system changes and
sends a signal to a **_build_** goroutine upon receiving
...
## Black boxes and solid foundations
